...
class SimpleWebSocketServer(object):
   def __init__(self, host, port, websocketclass, selectInterval = 0.1, game_server=None):
   ...
   def _constructWebSocket(self, sock, address):
      if self.game_server is None:
         ...
         return self.websocketclass(self, sock, address, game_server=self.game_server)
